...
mnist = input_data.read_data_sets("OPT_data/", one_hot=True)

# restore the saved model
new_saver = tf.train.import_meta_graph('data/opt_model/00000001/export.meta')
new_saver.restore(sess, 'data/opt_model/00000001/export')
